...
var componentMeta = map[ComponentKey]Meta{
	...
	"context_tokens_bar_pct": {Emoji: "📊", Name: "Context tokens + bar + %", Desc: "token counts with visual bar and percentage"},
	...
	"session_id":         {Emoji: "🆔", TextPrefix: "Session: ", Name: "Session ID", Desc: "Claude session ID for resuming elsewhere"},
...
var FeatureMeta = []struct {
	...
	{"session_id", componentMeta["session_id"]},
