...
func Default() *Config {
	return &Config{
		...
		Lines: []LineConfig{
			{Components: []string{"model", "effort", "agent", "directory", "worktree", "git_status", "lines_changed", "pr"}},
			{Components: []string{"context_bar", "tokens_full", "cache", "cost", "duration", "rate_limits_reset"}},
		},
	}
}
